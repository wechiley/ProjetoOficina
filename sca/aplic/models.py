...
class Funcionario(models.Model):
    ...
    ordensdeservico = models.ManyToManyField(OrdemDeServico)
    cargo = models.ForeignKey('Cargo', on_delete=models.SET_NULL, null=True, blank=True, related_name='funcionario')

    def __str__(self):
        cargos = [self.cargo.nomecargo] if self.cargo else []
        return f"{self.nomefuncionario} ({', '.join(cargos)})"
